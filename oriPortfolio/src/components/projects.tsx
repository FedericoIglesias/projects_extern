...
//   url: fileSimpsons,
// };
// const API = "https://github.com/Orianicole/repos";
// const API = "https://github.com/Orianicole?tab=repositorie";
const Projects = () => {
  const [projects, setProject] = useState([]);
  // const API = "https://api.github.com/users/Orianicole"
